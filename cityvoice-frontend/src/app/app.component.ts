...
export class AppComponent implements OnInit {
  ...
  isLandingRoute = false;   // landing gère son propre padding-top (navbar fixe transparente)
  ...
  ngOnInit(): void {
    ...
    this.router.events.pipe(
      ...
      this.isLandingRoute = url === '/' || url === '/landing' || url === '';
    });

    this.isAdminRoute   = this.router.url.startsWith('/admin');
    this.isAuthRoute    = this.router.url.startsWith('/auth');
    this.isLandingRoute = this.router.url === '/' || this.router.url === '/landing' || this.router.url === '';
